...
import 'solicitar_territorio_mixin.dart';
import 'envio_programado_mixin.dart';
import 'editar_direccion_mixin.dart';
import 'enviar_tarjeta_mixin.dart';
// CSV
...
class _PantallaHomeLegacyState extends State<PantallaHomeLegacy>
    with SingleTickerProviderStateMixin, SolicitarTerritorioMixin, EnvioProgramadoMixin, EditarDireccionMixin, EnviarTarjetaMixin {
  // Getters requeridos por mixins
  @override
  String get usuarioEmail => _usuarioEmail;
  @override
  Map<String, dynamic> get usuarioData => widget.usuarioData;
  @override
  bool get campanaEspecialActiva => _campanaEspecialActiva;
  ...
  void _mostrarNotificaciones() {
    NotificacionesDialog.mostrar(context, _usuarioEmail);
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          NotificacionesBadge(usuarioEmail: _usuarioEmail),
  ...
  void _mostrarDetallesDireccion(QueryDocumentSnapshot dirDoc) {
    DireccionDetalleDialog.mostrar(context, dirDoc, _campanaEspecialActiva);
  }
